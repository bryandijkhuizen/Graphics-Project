...
public class World implements Model {
    ...
    public static String availableStellagePositions, unavailableStellagePositions; 
    ...
    public void update() {
        ...
        if(!loaded){
            for(Object3D object : warehouseList){
                if(object instanceof Updatable && ((Updatable)object).update()){ 
    ...
    public void SimulationLoop(){
        ...
        if(truck.getStatus().equals("unloading")){
            ...
            for(Robot robot : robotList){
                if(robot.getStatus().equals("KlaarOmInTeLaden") && (robotList.get(0).getStellage() == null && robotList.get(1).getStellage() == null)) {
                        truck.setStatus("loading");
                }
                //als er nog stellages in de truck staan. Als de robot geen stellage vervoert:
                if(truck.countStellage() >= 0 && robot.getStellage() == null){
                ...
                } else{ truck.setStatus("loading"); } //als er geen stellages meer in de truck zijn is de truck aan het inladen
            }
        }       
