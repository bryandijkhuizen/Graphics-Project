...
public class Stellage implements Object3D, Updatable {
    ...
    private int ID, startX, startZ; 
    public static int xTarget, zTarget; 
    ...
    @Override
    public String getType() { return Stellage.class.getSimpleName().toLowerCase(); }
    public Integer getPosition(){ return (int)(x + (z/10)); }
    @Override
