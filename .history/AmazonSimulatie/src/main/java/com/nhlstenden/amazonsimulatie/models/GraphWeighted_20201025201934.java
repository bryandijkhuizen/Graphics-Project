...
public class GraphWeighted {
    ...
    // public NodeWeighted GetNodeWeighted(int i){
    // for (NodeWeighted n : nodes) {
    //         if(n.name == Integer.toString(i)){
    //             return n; 
    //         }
    //     }   
    // }
...
public String DijkstraShortestPath(NodeWeighted start, NodeWeighted end) {
    ...
    // TreeSet<NodeWeighted> myTreeSet = new TreeSet();
    // myTreeSet.addAll(nodes);
    // System.out.println(myTreeSet);

    // List<NodeWeighted> list = new ArrayList<NodeWeighted>(nodes); 
