...
public class GraphShow {
    ...
    public String GetRoute(int start, int end){
        ...
        NodeWeighted s = new NodeWeighted(start, Integer.toString(start));
        NodeWeighted e = new NodeWeighted(end, Integer.toString(end));
