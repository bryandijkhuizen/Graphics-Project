...
public class RobotTest{
    ...
    public void RobotTest() {
        Robot wallE = new Robot(null, 0, 0);
        Stellage ikea = new Stellage(0);
        Stellage jysk = new Stellage(1);
        ...
        ikea.setStellage(jysk);
        assertEquals("Storage object isn't jysk", jysk, wallE.getStellage());
        ...
        assertEquals("Robot doesn't have node 1 as end node", 1,wallE.getEnd(), 0.0);
